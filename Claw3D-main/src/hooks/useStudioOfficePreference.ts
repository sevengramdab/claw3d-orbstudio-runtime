...
export const useStudioOfficePreference = ({
  ...
  const setCrewDoctrine = useCallback(
    (doctrine: StudioCrewDoctrine) => {
      const gatewayKey = gatewayUrl.trim();
      setPreference((current) => ({
        ...current,
        modelLoadout: {
          ...current.modelLoadout,
          doctrine,
        },
      }));
      if (!gatewayKey) return;
  ...
  const setModelLoadoutField = useCallback(
    (
      field:
        | "primaryModel"
        | "fallbackModel"
  ...
  const setArchetypeModel = useCallback(
    (archetype: StudioAgentArchetype, value: string) => {
      const fieldByArchetype = {
        strategist: "strategistModel",
        builder: "builderModel",
        scout: "scoutModel",
        lorekeeper: "lorekeeperModel",
      } as const;
      setModelLoadoutField(fieldByArchetype[archetype], value);
    },
    [setModelLoadoutField]
  );
  ...
  return {
    ...
    modelLoadout: preference.modelLoadout,
    crewDoctrine: preference.modelLoadout.doctrine,
    primaryModel: preference.modelLoadout.primaryModel,
    fallbackModel: preference.modelLoadout.fallbackModel,
    strategistModel: preference.modelLoadout.strategistModel,
    builderModel: preference.modelLoadout.builderModel,
    scoutModel: preference.modelLoadout.scoutModel,
    lorekeeperModel: preference.modelLoadout.lorekeeperModel,
    setTitle,
    ...
    setCrewDoctrine,
    setPrimaryModel: (value: string) => setModelLoadoutField("primaryModel", value),
    setFallbackModel: (value: string) => setModelLoadoutField("fallbackModel", value),
    setArchetypeModel,
  };
};
