...
export function RetroOffice3D({
  ...
  crewDoctrine?: "balanced" | "specialized" | "chaotic";
  primaryModel?: string;
  ...
  crewResonancePct?: number | null;
  onCrewDoctrineChange?: (value: "balanced" | "specialized" | "chaotic") => void;
  onPrimaryModelChange?: (value: string) => void;
  onFallbackModelChange?: (value: string) => void;
  onArchetypeModelChange?: (
    archetype: "strategist" | "builder" | "scout" | "lorekeeper",
    value: string,
  ) => void;
          ...
          <div className="flex max-h-[calc(100vh-2rem)] w-full max-w-sm flex-col overflow-hidden rounded-xl border border-cyan-500/20 bg-[#05090d]/95 shadow-2xl">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto">
              <SettingsPanel
                ...
                onCrewDoctrineChange={(value) => onCrewDoctrineChange?.(value)}
                onPrimaryModelChange={(value) => onPrimaryModelChange?.(value)}
                onFallbackModelChange={(value) => onFallbackModelChange?.(value)}
                onArchetypeModelChange={(archetype, value) =>
                  onArchetypeModelChange?.(archetype, value)
                }
              ...
              {crewResonancePct !== null ? (
                <>
                  ...
                  <span className="text-cyan-400/70">
                    {crewDoctrine} doctrine {crewResonancePct}% sync
                  </span>
                </>
              ) : null}
