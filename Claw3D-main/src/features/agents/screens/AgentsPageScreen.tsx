  ...
  if (
    ...
    (!connectPromptReady ||
      (gatewayUrl.trim().length > 0 &&
        !shouldPromptForConnect &&
        (selectedAdapterType !== "openclaw" || token.trim().length > 0) &&
    ...
    return (
      <div className="relative h-full w-full overflow-hidden bg-background">
        <div className="relative z-10 flex h-full flex-col">
          ...
          />
          <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-3 pb-3 pt-3 sm:px-4 sm:pb-4 sm:pt-4 md:px-6 md:pb-6 md:pt-4">
            {settingsRouteActive ? (
