...
export type PackagedSkillId = "soundclaw" | "task-manager" | "tiktok-video-pipeline" | "todo-board";
...
const PACKAGED_SKILLS: PackagedSkillDefinition[] = [
  ...
  {
    packageId: "tiktok-video-pipeline",
    skillKey: "tiktok-video-pipeline",
    name: "tiktok-video-pipeline",
    description:
      "Research viral trends, generate short-form AI videos via ComfyUI, and publish them to TikTok through a coordinated three-agent pipeline.",
    installSource: "openclaw-workspace",
    creatorName: "iamlukethedev",
    creatorUrl: "https://github.com/iamlukethedev",
  },
