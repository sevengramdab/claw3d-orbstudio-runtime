...
> = {
  ...
  "tiktok-video-pipeline": {
    category: "Content",
    tagline:
      "Three-agent pipeline that researches viral trends, generates AI videos, and publishes to TikTok.",
    capabilities: [
      "Trend research & hashtag analysis",
      "ComfyUI video generation",
      "TikTok Content Posting API upload",
    ],
    featured: true,
    editorBadge: "Video pipeline",
    hideStats: true,
  },
};
