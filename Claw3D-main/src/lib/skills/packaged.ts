...
// Keep this string synchronized with assets/skills/tiktok-video-pipeline/SKILL.md.
const TIKTOK_VIDEO_PIPELINE_SKILL_MD = `---
...
// Keep this string synchronized with assets/skills/tiktok-video-pipeline/pipeline-state.example.json.
const TIKTOK_VIDEO_PIPELINE_EXAMPLE_JSON = `{
  "version": 1,
  "updatedAt": "2026-04-15T00:00:00.000Z",
  "activeJob": null,
  "completedJobs": [
    {
      ...
      "trendBrief": {
        "format": "Satisfying Process Loop",
        "hashtags": ["#satisfying", "#aiart", "#fyp", "#generativeart"],
        "targetDuration": 12
      },
      "videoPath": "generated-videos/satisfying-morph-001.mp4",
      "uploadId": "pub-7382940123",
      "tiktokUrl": "https://www.tiktok.com/@yourchannel/video/7382940123",
      "startedAt": "2026-04-14T18:00:00.000Z",
      "completedAt": "2026-04-14T18:02:30.000Z"
    }
  ],
  "metrics": {
    "totalVideos": 1,
...
const PACKAGED_SKILL_FILES: Record<string, PackagedSkillFile[]> = {
  ...
  "tiktok-video-pipeline": [
    {
      relativePath: "SKILL.md",
      content: TIKTOK_VIDEO_PIPELINE_SKILL_MD,
    },
    {
      relativePath: "pipeline-state.example.json",
      content: TIKTOK_VIDEO_PIPELINE_EXAMPLE_JSON,
    },
  ],
};
